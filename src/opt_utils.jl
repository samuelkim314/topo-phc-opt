...
"""
function globalopt(f::Function, x0::Vector, nlatticeparams::Integer, nflatparams::Integer, hasinv::Bool, 
...
"""
function localopt(f, x0::Vector, nlatticeparams::Integer, nflatparams::Integer, hasinv::Bool,
