...
loadstructname = joinpath(subdir, "4958")
# subdir = "sg75-dim3-n4.00/chern2-ff-direct/local-3-3186-best"
# loadstructname = joinpath(subdir, "1081")
...
# println(kp.points)
# println(pointgroup(primitivize(spacegroup(sgnum, Val(3)))))
...
# p = Brillouin.plot(cell)
# p2 = Brillouin.plot(kp)
# plotdata = append!(p.plot.data, p2.plot.data)
# PlotlyJS.plot(plotdata)
# # PlotlyJS.plot(latticize(kp, Rs))
