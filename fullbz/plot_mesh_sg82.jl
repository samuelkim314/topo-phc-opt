...
sgnum    = 82
D        = 3
subdir = "sg$sgnum-dim$D-n4.00/ff-direct/local-1-4286-best"
...
# nbandsbelow = 6
# # subdir = "sg$sgnum-dim$D-n4.00/ff-direct/local-8-4882-best"
...
pRs, flat, isoval, epsin, epsout, _ = lattice_from_mpbparams("output/$subdir/3136.sh") # Rs, flat, isoval, epsin, epsout, kvecs
