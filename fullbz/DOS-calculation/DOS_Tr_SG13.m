...
file_bandmap = subcalcname + "-freq_Tr.txt";
file_DOSdata = subcalcname + "-output.txt"; % save file for Density of states data
file_Gs = subcalcname + "-Gs.txt";
