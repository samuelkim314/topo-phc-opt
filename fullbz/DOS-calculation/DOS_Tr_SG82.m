...
subcalcname = "sg82-8-4882-4920";
file_bandline = 'sg27-6-4724-3160-freq_Tr.txt';
% file_bandmap = 'sg27-6-4724-3160-band.txt';
% file_bandmap = 'sg82-1-4286-4997-freq_Tr.txt';
% file_bandmap = 'sg82-4-3886-4803-freq_Tr.txt';
% file_bandmap = 'sg82-2-4911-3136-freq_Tr.txt';
% % file_bandmap = "sg82-8-4882-4920-freq_Tr.txt";
file_bandmap = "data/" + subcalcname + "-freq_Tr.txt";
file_DOSdata = "data/" + subcalcname + "-output.txt"; % save file for Density of states data
file_Gs = "data/" + subcalcname + "-Gs.txt";
...
reciprocalvector3 = [0 0 1];
Gs = importdata(file_Gs);
reciprocalvector1 = Gs(1, :);
reciprocalvector2 = Gs(2, :);
reciprocalvector3 = Gs(3, :);
...
num_kpoints = [41, 41, 41];
num_kpoints = [82, 41, 82];

N_band = 12; % the total number of frequency bands
...
elseif diagnal_len3 == diagnal_min
